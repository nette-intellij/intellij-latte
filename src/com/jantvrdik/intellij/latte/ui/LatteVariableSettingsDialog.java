...
public class LatteVariableSettingsDialog extends JDialog {
    ...
    private void onOK() {
        LatteVariableSettings settings = new LatteVariableSettings(this.textVarName.getText(), this.textVarType.getText(), this.checkboxNullable.isSelected());
        ...
        settings.setNullable(this.checkboxNullable.isSelected());
        dispose();
    }
