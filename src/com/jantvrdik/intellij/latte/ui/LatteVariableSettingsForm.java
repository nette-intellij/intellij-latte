...
public class LatteVariableSettingsForm implements Configurable {
	...
	private class VarNameColumn extends ColumnInfo<LatteVariableSettings, String> {
	...
	private class VarTypeColumn extends ColumnInfo<LatteVariableSettings, String> {
	...
	private class NullableColumn extends ColumnInfo<LatteVariableSettings, String> {
		...
		@Nullable
		@Override
		public String valueOf(LatteVariableSettings variableSettings) {
			return variableSettings.isNullable() ? "yes" : "no";
		}
	}
